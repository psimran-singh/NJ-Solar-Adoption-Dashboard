...
In New Jersey, homes with solar panels can sell for 9.9% more than homes without solar installations, an additional $32,281 at median housing value in New Jersey [[3]](https://www.cnbc.com/2019/10/05/solar-power-can-boost-a-homes-value-in-these-10-states-the-most.html#:~:text=In%20New%20Jersey%2C%20homes%20with,valued%20home%20in%20that%20state.). Investing in solar can also help homeowners save on energy costs.
...
In order to address this gap, New Jersey authorized a Community Solar Energy Pilot Program that allows residents to participate in community solar energy projects and benefit from local solar installations, which sell them energy directly at a lower rate. [[6]](https://earthjustice.org/news/press/2018/lawmakers-approve-bill-allowing-nj-renters-apartment-dwellers-to-access-solar-power). 
