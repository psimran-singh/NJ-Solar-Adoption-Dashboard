...
Adoption  Rate as the Independent Variable

### Income

```{r}
fig_income <- plot_ly(zip_level_res, x = zip_level_res$`Income`, y = zip_level_res$`Adoption_Rate`, type = "scatter") %>% 
...
```{r}
fig_perc_male <- plot_ly(zip_level_res, x = zip_level_res$`Perc_Male`, y = zip_level_res$`Adoption_Rate`, type = "scatter") %>% 
  layout(yaxis = list(title = "Solar Adoption Rate"),
         xaxis = list(title = "Percent of Population That's Male"),
         text = list(title = "Using Zip Code Level Data"))
...
```{r}
fig_perc_white <- plot_ly(zip_level_res, x = zip_level_res$`Perc_White`, y = zip_level_res$`Adoption_Rate`, type = "scatter") %>% 
  layout(yaxis = list(title = "Solar Adoption Rate"),
         xaxis = list(title = "Percent of Population That's White"),
         text = list(title = "Using Zip Code Level Data"))
...
### Percent of Owned Houses

```{r}
fig_perc_house_owned <- plot_ly(zip_level_res, x = zip_level_res$`Perc_House_Owned`, y = zip_level_res$`Adoption_Rate`, type = "scatter") %>% 
  layout(yaxis = list(title = "Solar Adoption Rate"),
...
```{r}
fig_income_c <- plot_ly(zip_level_res, x = zip_level_res$`Income`, y = zip_level_res$`CAPACITY`, type = "scatter") %>% 
  layout(yaxis = list(title = "Total Capacity"),
         xaxis = list(title = "Income"),
         text = list(title = "Using Zip Code Level Data"))
...
```{r}
fig_perc_male_c <- plot_ly(zip_level_res, x = zip_level_res$`Perc_Male`, y = zip_level_res$`CAPACITY`, type = "scatter") %>% 
  layout(yaxis = list(title = "Total Capacity"),
         xaxis = list(title = "Percent of Population That's Male"),
         text = list(title = "Using Zip Code Level Data"))
...
```{r}
fig_perc_white_c <- plot_ly(zip_level_res, x = zip_level_res$`Perc_White`, y = zip_level_res$`CAPACITY`, type = "scatter") %>% 
  layout(yaxis = list(title = "Total Capacity"),
         xaxis = list(title = "Percent of Population That's White"),
         text = list(title = "Using Zip Code Level Data"))
...
```{r}
fig_perc_house_owned_c <- plot_ly(zip_level_res, x = zip_level_res$`Perc_House_Owned`, y = zip_level_res$`CAPACITY`, type = "scatter") %>% 
  layout(yaxis = list(title = "Total Capacity"),
         xaxis = list(title = "Percent of Population That Owns Their House"),
         text = list(title = "Using Zip Code Level Data"))

fig_perc_house_owned_c
```